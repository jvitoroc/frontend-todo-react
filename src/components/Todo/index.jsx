        ...
        return (
            <div className={classes["todo-wrapper"]}>
                <div onContextMenu={this.onContextMenu} className={todoClasses}>
                    ...
                    <div onClick={this.onClick} onInput={this.onTextInput} onKeyDown={this.onKeyDown} onBlur={this.onTextBlur} ref={this.textRef} suppressContentEditableWarning={true} contentEditable={this.props.editingDescription} className={classes['text']}>
                        <div>
